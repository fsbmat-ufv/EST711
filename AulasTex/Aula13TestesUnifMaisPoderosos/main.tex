...
\begin{frame}{}
	\begin{block}{Interpretação prática}
		...
		\]
		Portanto, o poder em $\theta = 2$ é o \textbf{supremo da função poder sob $H_0$}, e o teste é dito ter \textbf{tamanho 0.05}.
		
		Essa propriedade garante que o teste é válido, isto é, não ultrapassa o nível de significância especificado, sendo também o mais poderoso entre todos os testes com esse mesmo tamanho.
	\end{block}
\end{frame}

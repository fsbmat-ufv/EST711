...
\usepackage{multicol}
\usepackage{csquotes}
\usepackage[backend=bibtex, citestyle=authoryear, maxcitenames=2, terseinits=true, natbib=true, maxbibnames=99, style=abnt]{biblatex}
\addbibresource{..\AulasEST711\Referencias\Referencias.bib}

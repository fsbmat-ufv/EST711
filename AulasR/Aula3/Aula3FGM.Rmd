...
<style>
h2 {
  margin-top: 100px;  /* Ajuste a distância conforme necessário */
}
</style>


# Aula 3 {.aumenteTopMarginText}

## Sumário {.aumenteTopMarginText}
...
## Função Geradora de Momentos {.aumenteTopMarginText}
